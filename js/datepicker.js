...
.directive('uibDatepickerPopup', function() {
  return {
    // pulls in the the controller for the 4th argument of the link function
    // so link function now has ngModelController and uibDatePickerPopupController
    require: ['ngModel', 'uibDatepickerPopup'],
    controller: 'UibDatepickerPopupController',
    scope: {
      // = indicates 2 way binding
      // ? indicates optional
      // @ indicates 1 way binding - If the parent scope changes, the isolated scope will 
      // reflect that change
      datepickerOptions: '=?',
      isOpen: '=?',
      currentText: '@',
